...
var xlsx = XLSX;
function extname(fname) { return fname.substr((~-fname.lastIndexOf(".") >>> 0) + 2); }
...
Workbook.prototype.save = function(name){
	...
	var wbBlob = new Blob([s2ab(wbout)], {typpe:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
	return wbBlob;
}
