(function () {
	...
	function config ($stateProvider, $urlRouterProvider, $translateProvider) {
		...
		$translateProvider.translations('en', {
			...
			product_Category_choose_category: "Choose from Existent Category",
		...
		$translateProvider.translations('es', {
			...
			product_input_category: "Entra Nombre de Categoría",
			product_add_inventory: "Agregar al Inventario",
			product_Category_add: "Agregar",
			product_Category_choose: "Escoger",
			product_Category_choose_category: "Escoge Categoría Existente",
